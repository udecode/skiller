...
- Tracks plugin-managed items via `.claude/.skiller.json` (per project, grouped by agent skills dir)
...
- Tracks project-managed items via `.claude/.skiller.json` (per project, grouped by agent skills dir)
